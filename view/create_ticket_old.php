...
<div class="main">
    < <?php if (in_array($_SESSION['role_name'], ['Admin', 'Project Manager', 'Submitter'])) : ?> <div class="manage_project_users">
        <div class="wrapper">
            <!-- Select Project -->
...
<script>
    function choose_project(project_id) {
        ...
        url = 'create_ticket.php?project_id=' + project_id + '&search=' + search_input;
        window.location = url;
    }
