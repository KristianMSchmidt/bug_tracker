        ...
        <div class="manage_project_users">
            <div class="top">
                ...
                <?php if (isset($_POST['project_id'])) : ?>
                    ...
                    <a href="#" class="right" onclick="document.getElementById('project_details_form').submit()">Project Details</a>
                <?php endif ?>
            </div>
            <div class="wrapper">
                <?php if (isset($_POST['project_id'])) : ?>
                    <div class="orto-wrapper table card">
                        ...
                        <div class="orto-wrapper card">
                            ...
                            <div class="w3-container" style="width:400px;">
                                ...
                                <div class=" w3-container">
                                    ...
                                    <input type="submit" name="proceed" value="Proceed" class="btn-primary" form="project_form" style="width:100%;">
