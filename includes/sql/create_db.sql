...
INSERT INTO users(username, password, email, role) VALUES('Kristian_admin', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','kimarokko@hotmail.com', 1);
INSERT INTO users(username, password, email, role) VALUES('Demo Admin', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','demoadmin@hotmail.com', 1);
INSERT INTO users(username, password, email, role) VALUES('Demo Developer', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','demodev@hotmail.com', 3);
INSERT INTO users(username, password, email, role) VALUES('Demo Project Manager', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','demopm@hotmail.com', 2);
INSERT INTO users(username, password, email, role) VALUES('Albert Einstein', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','albert@mail.com', 2);
INSERT INTO users(username, password, email, role) VALUES('Steven Pinker','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','steven@mail.com', 2);
INSERT INTO users(username, password, email, role) VALUES('Gerard Folland','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','gerard@mail.com', 3);
INSERT INTO users(username, password, email, role) VALUES('Richard Dawkins','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','richard@mail.com', 3);
INSERT INTO users(username, password, email, role) VALUES('Maxin Lapan','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','maxin@mail.com',3);
INSERT INTO users(username, password, email, role) VALUES('Slavoj Zizek','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','slavoj@mail.com',3);
INSERT INTO users(username, password, email, role) VALUES('Susan Pinker','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','susan@mail.com', 3);
INSERT INTO users(username, password, email, role) VALUES('Rüdiger Safranski','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','rödiger@mail.com', 3);
INSERT INTO users(username, password, email, role) VALUES('Kristian_pm', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','k_pm@mail.com', 2);
INSERT INTO users(username, password, email, role) VALUES('Kristian_dev', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','k_devn@mail.com', 3);
INSERT INTO users(username, password, email, role) VALUES('Demo Submitter', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','k_submitn@mail.com', 4);
...
INSERT INTO ticket_types(ticket_type_name) VALUES('Feaure Request');
