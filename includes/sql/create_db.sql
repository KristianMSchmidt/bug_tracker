...
INSERT INTO users(username, password, email, role_id) VALUES('Kristian_admin', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','kimarokko@hotmail.com', 1);
INSERT INTO users(username, password, email, role_id) VALUES('Demo Admin', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','demoadmin@hotmail.com', 1);
INSERT INTO users(username, password, email, role_id) VALUES('Demo Developer', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','demodev@hotmail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('Demo Project Manager', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','demopm@hotmail.com', 2);
INSERT INTO users(username, password, email, role_id) VALUES('Albert Einstein', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','albert@mail.com', 2);
INSERT INTO users(username, password, email, role_id) VALUES('Steven Pinker','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','steven@mail.com', 2);
INSERT INTO users(username, password, email, role_id) VALUES('Gerard Folland','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','gerard@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('Richard Dawkins','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','richard@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('Maxin Lapan','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','maxin@mail.com',3);
INSERT INTO users(username, password, email, role_id) VALUES('Slavoj Zizek','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','slavoj@mail.com',3);
INSERT INTO users(username, password, email, role_id) VALUES('Susan Pinker','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','susan@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('Rüdiger Safranski','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','rödiger@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('Kristian_pm', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','k_pm@mail.com', 2);
INSERT INTO users(username, password, email, role_id) VALUES('Kristian_dev', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','k_devn@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('Demo Submitter', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','k_submitn@mail.com', 4);
...
INSERT INTO ticket_types(ticket_type_name) VALUES('Feaure Requests');
INSERT INTO ticket_types(ticket_type_name) VALUES('Bugs/Errors');
