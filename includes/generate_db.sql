...
INSERT INTO users(username, password, email, role_id) VALUES('KristianAdmin', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','kimarokko@hotmail.com', 1);
INSERT INTO users(username, password, email, role_id) VALUES('DemoAdmin', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','demoadmin@gmail.com', 1);
INSERT INTO users(username, password, email, role_id) VALUES('DemoDev', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','demodev@gmail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('DemoPM', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','demopm@gmail.com', 2);
INSERT INTO users(username, password, email, role_id) VALUES('AlbertEinstein', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','albert@mail.com', 2);
INSERT INTO users(username, password, email, role_id) VALUES('StevenPinker','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','steven@mail.com', 2);
INSERT INTO users(username, password, email, role_id) VALUES('GerardFolland','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','gerard@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('RichardDawkins','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','richard@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('MaxinLapan','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','maxin@mail.com',3);
INSERT INTO users(username, password, email, role_id) VALUES('SlavojZizek','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','slavoj@mail.com',3);
INSERT INTO users(username, password, email, role_id) VALUES('SusanPinker','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','susan@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('RüdigerSafranski','$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','rödiger@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('KristianPM', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','k_pm@mail.com', 2);
INSERT INTO users(username, password, email, role_id) VALUES('KristianDev', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','k_devn@mail.com', 3);
INSERT INTO users(username, password, email, role_id) VALUES('DemoSub', '$2y$10$aaHfd.sfetH.JY6JMFkQveIF0UjKl85tBZBE7VGkfWI3vBIXZjPFK','k_submitn@gmail.com', 4);
